...
<body>
	...
	<ul id="dropdown1" class="dropdown-content">
	  ...
	  <li><a href="#!">two</a></li>
	  <li class="divider"></li>
	  <li class="red"><a href="#!" style="color: #fff;">DELETE ACCOUNT</a></li>
	</ul>
	...
	<nav class="deep-orange darken-4">
		<div class="nav-wrapper container">
			...
			<ul class="right">
		      <li><a class="dropdown-trigger" href="#!" data-target="dropdown1">${username}<i class="material-icons right">account_circle</i></a></li>
		    </ul>
		</div>
	</nav>
						...
						<div class="card-content">
							<form action="addNote" method="post">
								...
								<div class="row" style="margin: 0px;">
									...
									<button class="btn waves-effect waves-light yellow darken-4 right" type="submit">Create Note</button>
								</div>
							</form>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-content">
								<form action="updateNote" method="post">
									<div class="row">
										<a href="./removeNote?idNote=${notes.id}&idUser=${notes.idUser}" style="color: #000;"><i class="close material-icons right">close</i></a>
									...
									<div class="row" style="margin: 0px;">
										...
										<button class="btn waves-effect waves-light yellow darken-4 right" type="submit">Save</button>
									</div>
								</form>
							</div>
						</div>
